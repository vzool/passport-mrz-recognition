...
/**License expired*/
#define DLRERR_LICENSE_EXPIRED			-10004

/**File not found*/
#define DLRERR_FILE_NOT_FOUND			-10005 

/**The file type is not supported. */
#define DLRERR_FILETYPE_NOT_SUPPORTED	-10006 

/**The BPP (Bits Per Pixel) is not supported. */
#define DLRERR_BPP_NOT_SUPPORTED		-10007 

/**Failed to read the image. */
#define DLRERR_IMAGE_READ_FAILED		-10012

/**Failed to read the TIFF image. */
#define DLRERR_TIFF_READ_FAILED			-10013

/**Failed to read the PDF image. */
#define DLRERR_PDF_READ_FAILED			-10021

/**The PDF DLL is missing. */
#define DLRERR_PDF_DLL_MISSING			-10022

/**Recognition timeout*/
#define DLRERR_RECOGNITION_TIMEOUT		-10026

/**Json parse failed*/
#define DLRERR_JSON_PARSE_FAILED		-10030 

/**Json type invalid*/
#define DLRERR_JSON_TYPE_INVALID		-10031 

/**Json key invalid*/
#define DLRERR_JSON_KEY_INVALID			-10032 

/**Json value invalid*/
#define DLRERR_JSON_VALUE_INVALID		-10033 

/**Json name key missing*/
#define DLRERR_JSON_NAME_KEY_MISSING    -10034

/**The value of the key "Name" is duplicated.*/
#define DLRERR_JSON_NAME_VALUE_DUPLICATED    -10035

/**Template name invalid*/
#define DLRERR_TEMPLATE_NAME_INVALID	-10036

/**Parameter value invalid*/
#define DLRERR_PARAMETER_VALUE_INVALID	-10038

/**Failed to set mode's argument.*/
#define DLRERR_SET_MODE_ARGUMENT_ERROR  -10051

/**Failed to get mode's argument.*/
#define DLRERR_GET_MODE_ARGUMENT_ERROR  -10055
...
typedef struct tagDLRReferenceRegion
{
	...
	*
	* @par Value range:
	* 	    A value of the DLRLocalizationSourceType Enumeration items.
	* @par Default value:
